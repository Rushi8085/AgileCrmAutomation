...
public class TestListeners1 extends BaseClass implements ITestListener, ISuiteListener {
...
//		String methodName=result.getMethod().getMethodName();
	...
	public void onTestFailure(ITestResult result) {
		...
		String outputPath=System.getProperty("user.dir")+"//ExecutionResult//Screenshot//"+fileName+"RK.png";
